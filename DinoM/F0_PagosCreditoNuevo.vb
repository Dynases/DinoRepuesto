...
Public Class F0_PagosCreditoNuevo
...
#Region "METODOS PRIVADOS"
    ...
    Private Sub _prDetalleCobranzas(_numi As Integer)
        ...
        With grfactura.RootTable.Columns("tcty4clie")
            ...
            .Visible = False
        End With
        With grfactura.RootTable.Columns("totalCredito")
            .Width = 100
            .FormatString = "0.00"
            .Visible = True
            .TextAlignment = TextAlignment.Far
...
#End Region
        ...
        If (e.KeyData = Keys.Enter) Then
            ...
            If (f >= 0) Then
                ...
                If ((pos >= 0) And (Not existe)) Then
                    ...
                    CType(grfactura.DataSource, DataTable).Rows(pos).Item("totalCredito") = grPendiente.GetValue("totalfactura")
    ...
    Public Function _ValidarCampos() As Boolean
        ...
        If (grfactura.RowCount > 0) Then
            ...
            If (grfactura.GetValue("PagoAc") = 0) Then
                Dim img As Bitmap = New Bitmap(My.Resources.mensaje, 50, 50)
                ToastNotification.Show(Me, "Por Favor debe especificar el monto cobrado".ToUpper, img, 2000, eToastGlowColor.Red, eToastPosition.BottomCenter)
                Return False
            End If
    ...
    Private Sub P_GenerarReporteDirecto(numi As String)
        Dim dt As DataTable = L_fnCobranzasReporte(numi)
        Dim total As Double = dt.Compute("SUM(importe)", "")
        If Not IsNothing(P_Global.Visualizador) Then
            P_Global.Visualizador.Close()
        End If

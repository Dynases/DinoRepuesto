...
#Region "TY005 PRODUCTOS"
    ...
    Public Shared Function L_prCargarImagenesProductoAll() As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prCargarImagenProducto(yfnumi As String) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_fnDetalleProducto(_numi As String) As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnHistoricoPreciosProducto(_numi As String) As DataTable
        Dim _Tabla As DataTable
...
#Region "TC001 Compras"
    ...
    Public Shared Function L_fnGrabarCompra(_canumi As String, _caalm As Integer, _cafdoc As String, _caTy4prov As Integer, _catven As Integer, _cafvcr As String,
                                            _camon As Integer, _caobs As String, _cadesc As Double, _catotal As Double, detalle As DataTable, detalleCompra As DataTable,
                                            _emision As Integer, _numemision As Integer, _consigna As Integer, _retenc As Integer, _tipocambio As Double,
                                            EsPrestamo As Integer, _Proforma As String) As Boolean
        Dim _Tabla As DataTable
        Dim _resultado As Boolean
        Dim _listParam As New List(Of Datos.DParametro)
        ...
        _listParam.Add(New Datos.DParametro("@EsPrestamos", EsPrestamo))
        _listParam.Add(New Datos.DParametro("@caProforma", _Proforma))
...
#Region "TD002 DEVOLUCIONES"
    ...
    End Function
#End Region
#Region "TP002 PROFORMA COMPRA"

    Public Shared Function L_fnEliminarProformaCompra(numi As String, ByRef mensaje As String) As Boolean
        Dim _resultado As Boolean
        ...
        Return _resultado
    End Function
    Public Shared Function L_fnGrabarProformaCompra(_canumi As String, _pcfdoc As String, _pcty4prov As Integer, _pcobs As String, _pcdesc As Double,
        ...
        _listParam.Add(New Datos.DParametro("@tipo", 1))
        _listParam.Add(New Datos.DParametro("@pcnumi", _canumi))
        _listParam.Add(New Datos.DParametro("@pcfdoc", _pcfdoc))
        _listParam.Add(New Datos.DParametro("@pcty4prov", _pcty4prov))
        ...
        Return _resultado
    End Function
    Public Shared Function L_fnModificarProformaCompra(_canumi As String, _pcfdoc As String, _pcty4prov As Integer, _pcobs As String, _pcdesc As Double,
                                                    _pctotal As Double, detalle As DataTable) As Boolean
        Dim _Tabla As DataTable
        Dim _resultado As Boolean
        Dim _listParam As New List(Of Datos.DParametro)
        ...
        Return _resultado
    End Function
    Public Shared Function L_fnGeneralProformaCompra() As DataTable
        Dim _Tabla As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnDetalleProformaCompra(_numi As String) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_fnGeneralProformaNoUtilizada() As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnVerificarSiExisteEnCompra(_numi As String) As DataTable
        Dim _Tabla As DataTable
